...
## 2026-09-08 — riconciliazione del progetto e regola di verifica

Il proprietario richiede di verificare anche i moduli precedentemente dichiarati fatti: implementato, CI verde, artefatto presente e funzionalmente validato sono stati diversi. Non trattare un report GPT/Work come prova autonoma; usare sorgenti, test appropriati, log e ambiente reale. Preservare ciò che esiste; nessun pivot, ricostruzione o nuovo modulo automatico.

Riconciliazione iniziale completata sui sorgenti Assembling `8e94db9e692e387f8ef2b5d528f8dd3f1c1d8fcf` e Lab `815b1ca53e12ed392499e5ddce0d6d97431e7b99`. Prove/report: `reports/MATRIX_PROJECT_RECONCILIATION_20260908.md`, directory `reports/evidence/matrix-project-reconciliation-20260908/` con `SHA256SUMS`. Assembling letto soltanto: 80 blob, 27 file Kotlin principali, 18 file test; CI corrente run 34191239860 verificata nei log, ma integration-static-nlu/EchoGgufAdapter non dimostrano la catena con modelli reali. Memoria persistente e diversi domini restano NON_CABLATO; collegamento canonico V3→Authority→prompt da verificare. MIP è autorità semantica e TurnFrame contenitore, non sostituti. ARCHITETTURA.md del lab è piano Python DESIGN_ONLY e non va confuso con runtime Kotlin corrente.

Student-5 rimane CP47 completato, 10 checkpoint e selezione CP48 BLOCKED, zero valutati. Student-4 conserva FAILED_DEV_GATE + autorizzazione R2, non production approval. E5 è un candidato separato importato nel lab, non sostituisce Student-5: path `understanding/candidates/jangedoo-multilingual-e5-small-pruned/`, upstream 696e4b64a2e33f6ffa036d24a666a16fd2280556; modello LFS 351646568 byte / e8de21ecee219f55eb9a29e3f0ba7a6167756b6109512d201895b3158e97ae3e; tokenizer LFS 17082735 byte / 6040ba36e3e2f7b2fa6ae076b69d024a08666bea4c345105a32e542900fcc7e7. Import run 34191899115 e upload 2/2 verificati nei log; nuovo readback binario/inferenza non eseguiti. Il Colab 2/8 resta esplorativo non riprodotto.

Stato: RECONCILIATION_COMPLETE_FUNCTIONAL_VALIDATION_PENDING. Nessuna nuova suite, inferenza, training, modifica dataset o integrazione in questa ricognizione. Prossimo checkpoint soltanto proposto: verifica deterministica del confine canonico V3→Authority→prompt, un task alla volta, senza sviluppare altri moduli. Recuperare il report dal commit che introduce questa sezione e verificare SHA256SUMS; final HEAD/readback nel messaggio di consegna.
